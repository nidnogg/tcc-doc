...
\section{Avaliação de Propostas de Hardening}
...
\begin{figure}[ht]
    ...
    \legend{Fonte: \href{https://www.sciencedirect.com/science/article/pii/S016740482100420X}{Z. Liu, Y.Fang, C. Huang et al via Scopus} (2022, p. TO-DO)}
    \label{fig:internet} 
\end{figure}
...
Sua implementação é tanto uma biblioteca como uma ferramenta de linha de comando
