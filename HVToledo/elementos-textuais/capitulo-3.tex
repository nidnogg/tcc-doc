...
O fuzzer \textit{generation-based} necessita saber como é a entrada que o programa é capaz de processar. No caso de um fuzzing para arquivos, geralmente é fornecido um arquivo de configuração com o modelo pré-definido de entrada. Os testcases são gerados de acordo com o arquivo de configuração. Fuzzers desse tipo tem facilidade em burlar validações do software testado, permitindo ao pentester entender com mais profundidade a aplicação estudada. Por outro lado, sem uma documentação amigável, analisar o formato do arquivo pode ser uma tarefa árdua.
Em termos de praticidade, fuzzers mutation-based são mais fáceis de utilizar, com aplicabilidade genérica, sendo geralmente o tipo adotado por testes de intrusão no estado da arte. Diferente do generation-based, o mutation-based precisa de alguns inputs iniciais válidos. Os inputs vão sofrendo mutações e novos testcases vão sendo gerados. O wafamole++ requer apenas uma entrada inicial válido - uma query que é fornecida ao final de cada chamada ao comando \verb+wafamole evade+.

Para testes \textit{grey box} e \textit{black box}, os fuzzers são \textit{mutation-based}. Para testes \textit{white box}, \textit{generation-based}.
...
% \begin{figure}[ht]
%     \centering
%     \caption{Conjunto Inicial de Amostras}
%     \includegraphics[width=14cm]{figuras/adaboost/amostras.png} 
%     \legend{Fonte: \href{https://link.springer.com/chapter/10.1007/978-3-642-18129-0_1}{Some Analysis and Research of the AdaBoost Algorithm} (2022, p. TO-DO)}
%     \label{fig:internet} 
% \end{figure}
...
% \begin{figure}[ht]
%     \centering
%     \caption{Distribuição Inicial}
%     \includegraphics[width=5cm]{figuras/adaboost/distribuicao_pesos_inicial.png} 
%     \legend{Fonte: \href{https://link.springer.com/chapter/10.1007/978-3-642-18129-0_1}{Some Analysis and Research of the AdaBoost Algorithm} (2022, p. TO-DO)}
%     \label{fig:internet} 
% \end{figure}
...
Considerando t = 1, ... , T, tem-se um loop com os pesos normalizados:

% \begin{figure}[ht]
%     \centering
%     \caption{Peso Normalizado}
%     \includegraphics[width=5cm]{figuras/adaboost/peso_normalizado.png} 
%     \legend{Fonte: \href{https://link.springer.com/chapter/10.1007/978-3-642-18129-0_1}{Some Analysis and Research of the AdaBoost Algorithm} (2022, p. TO-DO)}
%     \label{fig:internet} 
% \end{figure}
...
%     \includegraphics[width=7cm]{figuras/adaboost/taxa de erro.png} 
%     \legend{Fonte: \href{https://link.springer.com/chapter/10.1007/978-3-642-18129-0_1}{Some Analysis and Research of the AdaBoost Algorithm} (2022, p. TO-DO)}
%     \label{fig:internet} 
% \end{figure}
...
%     \includegraphics[width=7cm]{figuras/adaboost/atualização dos pesos.png} 
%     \legend{Fonte: \href{https://link.springer.com/chapter/10.1007/978-3-642-18129-0_1}{Some Analysis and Research of the AdaBoost Algorithm} (2022, p. TO-DO)}
%     \label{fig:internet} 
% \end{figure}
...
%     \centering
%     \caption{Saída Final}
%     \includegraphics[width=12cm]{figuras/adaboost/saída do algoritmo.png} 
%     \legend{Fonte: \href{https://link.springer.com/chapter/10.1007/978-3-642-18129-0_1}{Some Analysis and Research of the AdaBoost Algorithm} (2022, p. TO-DO)}
%     \label{fig:internet} 
% \end{figure}
